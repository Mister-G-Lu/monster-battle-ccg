...
const SHELL = [
  ...
  './build/web/assets/logo.png',
  './build/web/assets/bg/world.png',
  './build/web/assets/bg/battle_empty.png',
  './build/web/assets/ui/crystal.png',
  './build/web/assets/icons/icon-192.png',
  './build/web/assets/icons/icon-512.png',
  './build/web/assets/icons/maskable-192.png',
  './build/web/assets/icons/maskable-512.png',
];
