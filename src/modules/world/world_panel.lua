...
function meta:RegisterEvent()
    ...
    graphic:RegisterEvent("switch_system_module",function (func_name)
        ...
        -- Bug fix: previously only "home" and "deck" were handled here.
        -- Switching to "campaign" (Adventure) or any other full-screen module
        -- left world_panel visible and covering the incoming panel, so tapping
        -- Adventure appeared to do nothing. Now any module that is not "home"
        -- hides world_panel, matching what "deck" already did.
